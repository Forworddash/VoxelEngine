...
SCREEN_WIDTH, SCREEN_HEIGHT = WIN_RES.x, WIN_RES.y
...
CAMERA_POSITION = glm.vec3(0, PLAYER_HEIGHT * 1.5, -PLAYER_DEPTH * 2)
CAMERA_YAW = 0 # adjust as needed
CAMERA_PITCH = 0 # adjust as needed 
